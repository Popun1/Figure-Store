...
<html class="no-js" lang="vi">
    ...
    <body>
        ...
        <div class="slider_area slider_style home_three_slider owl-carousel">
            <div class="single_slider" data-bgimg="assets/img/slider/slide9.jpg">
                <div class="container">
            ...
            <div class="single_slider" data-bgimg="assets/img/slider/slide10.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
            ...
            <div class="single_slider" data-bgimg="assets/img/slider/slide11.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/ban8.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/ban9.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area bottom">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/ban10.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-lg-6 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/ban11.jpg" alt="#"></a>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/ban12.jpg" alt="#"></a>
